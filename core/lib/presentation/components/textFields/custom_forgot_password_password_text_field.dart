...
class CustomForgotPasswordPasswordTextField extends StatelessWidget {
  const CustomForgotPasswordPasswordTextField({
    Key? key,
  }) : super(key: key);
    ...
    return BlocBuilder<ForgotPasswordFormBloc, ForgotPasswordFormState>(
      builder: (context, forgotPassForm) {
        return TextFormField(
          initialValue: forgotPassForm.password,
          obscureText: forgotPassForm.obsecurePassword,
            ...
            suffixIcon: Padding(
              ...
              child: GestureDetector(
                onTap: (() => context.read<ForgotPasswordFormBloc>().add(
                      ForgotPasswordFormObsecurePasswordChanged(
                        obsecure: !forgotPassForm.obsecurePassword,
                      ),
                    )),
                child: SvgPicture.asset(
                  (forgotPassForm.obsecurePassword)
                      ? "assets/icon/eye.svg"
          ...
          onChanged: (text) => context.read<ForgotPasswordFormBloc>().add(
                ForgotPasswordFormPasswordChanged(
                  password: text,
                ),
              ),
        );
